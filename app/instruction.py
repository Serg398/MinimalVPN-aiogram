...
async def text_instruction():
       ...
       text = f"1. В меню 'Управление устройствами' добавьте новое устройство.\n" \
              ...
              "6. Включите тумблер.\n\n"\
              "Об оплате:\n"\
              "Для обеспечения безопасности финансовые операции производятся средствами Telegram и Яндекс.Кассы(ЮMoney).\n" \
              "Данные карт не передаются третьим лицам и нашему сервису. С нашей стороны мы видим только статус оплаты.\n" \
              ...
              "При удалении устройства данные об оплате удаляются."
       return text
